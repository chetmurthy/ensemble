// $Header: /cvsroot/ensemble/maestro/corba/Maestro_CORBA.C,v 1.1 2003/04/26 13:38:31 orodeh Exp $
// 
...
void
Maestro_CORBA_String::operator>> (ostream &out) {
    assert(size && s != NULL);
    assert(NULL_STRING[0] == 0);  
    assert(size == strlen(s) + 1);
...
void 
Maestro_CORBA_Exception::operator>> (ostream &out) {
