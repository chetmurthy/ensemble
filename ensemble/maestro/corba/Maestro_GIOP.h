// $Header: /cvsroot/ensemble/maestro/corba/Maestro_GIOP.h,v 1.1 2003/04/26 13:38:31 orodeh Exp $
// 
...
class Maestro_IOP_IOR: virtual public Maestro_CORBA_Serializable
{
 public: 
    Maestro_IOP_IOR() {}
    ~Maestro_IOP_IOR() {}
...
class Maestro_IIOP_IOR: Maestro_IOP_IOR
{
 public:
    Maestro_IIOP_IOR() {}
