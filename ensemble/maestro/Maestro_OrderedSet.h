 ...
 */
/**************************************************************/
// $Header: /cvsroot/ensemble/maestro/Maestro_OrderedSet.h,v 1.1.1.1 2003/08/24 06:52:17 nystrom Exp $
  ...
  Maestro_OrderedSet ## T (Maestro_OrderedSet ## T &l,           \
    ...
    if (listSize) {                                              \
      ...
      list = 0;                                                  \
                                                                 ...
                                                                 \
  Maestro_OrderedSet ## T (T *tp, int nelem,                \
			   Maestro_ErrorHandler *error_handler = 0) : \
    Maestro_Base(error_handler) {                                \
    listSize = nelem;                                            \
    if (listSize) {                                              \
