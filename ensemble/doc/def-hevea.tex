\usepackage{/usr/lib/hevea/hevea}
\long\def\omitit#1{}
...
%But this does not work well, so I just use vanilla \epsfig
\newcommand{\putfig}[2]{%
\begin{toimage}
{\scalebox{#1}{\includegraphics{#2}}}
\end{toimage}%
...
\newcommand{\putexactfig}[3]{%
\begin{toimage}
{\epsfig{figure=#1,width=#2,height=#3}}
\end{toimage}%
\imageflush}

\newcommand{\putfigfbox}[2]     {%
\begin{toimage}
\fbox
{ \scalebox{#1}{\includegraphics{#2}} } 
\end{toimage}%
