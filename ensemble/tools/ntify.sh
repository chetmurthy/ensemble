...
for i in demo/Makefile demo/life/Makefile demo/tk/Makefile demo/dbm/Makefile \
    Makefile Makefile.top ce/Makefile cs/Makefile hot/Makefile crypto/Makefile \
    maestro/Makefile; do
      echo "  " $i
...
#
# Don't do this for ejava: they have their own build process.
#
for i in appl mm crypto crypto/isaac crypto/OpenSSL doc doc/layers groupd \
    infr layers maestro mk route socket socket/u socket/s socket/s/unix socket/s/nt \
